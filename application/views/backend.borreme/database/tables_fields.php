                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" id="project" name="project">
                        <option value=""></option>
                        <option value="1">sddsfdsf sdfs d</option>
                        <option value="2">fsd fsdf sdfds</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="version" name="version" placeholder="Type version">
                    </div>
                  </div>
                </div>
                <!-- /.box-body -->
              ...
              <form class="form-horizontal">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="sql" name="sql" placeholder="Type SQL" rows="5"></textarea>
                    </div>
                  </div>
                </div>
                <!-- /.box-body -->
