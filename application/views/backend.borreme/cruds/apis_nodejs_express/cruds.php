  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">APIs Node.js Express</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
              ...
              <button type="button" class="btn btn-block btn-info btn-lg" id="generateSelectRows">Generate APIs Node.js Express</button>
              <br>
...
?>
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/apis_nodejs_express/crud/<?php echo $row["id"]; ?>" class="btn btn-block btn-success btn-xs">CRUD</a>
                              <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/apis_nodejs_express/generate_list/<?php echo $row["id"]; ?>" class="btn btn-block btn-info btn-xs">Generate</a>
                            </td>
