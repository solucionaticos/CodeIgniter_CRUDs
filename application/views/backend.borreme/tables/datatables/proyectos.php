    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/proyectos/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  

                    <input type='hidden' id='id_i' name='id' value='0'>
                    
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="id_i">Id:</label>
                    	<div class="col-sm-10">
	                    	<input type="number" class="form-control" id="id_i" name="id">
                    	</div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open($this->config->item('adminPath') . '/proyectos/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              

                    <input type='hidden' id='id_g' name='id'>
                    
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="id_g">Id:</label>
                    	<div class="col-sm-10">
	                    	<input type="number" class="form-control" id="id_g" name="id">
                    	</div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/proyectos/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
