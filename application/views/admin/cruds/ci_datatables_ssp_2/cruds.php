  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Codeigniter + Datatables.net + SSP 2.0
        <small>Project: <?php echo $projectVersionTitle; ?></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Codeigniter + Datatables.net 2.0</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
              ...
              <button type="button" class="btn btn-block btn-info btn-lg" id="generateSelectRows">Generate Codeigniter + Datatables.net 2.0</button>
              <br>
...
?>
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/ci_datatables_ssp_2/crud/<?php echo $row["id"]; ?>" class="btn btn-block btn-success btn-xs">CRUD</a>
                              <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/ci_datatables_ssp_2/generate_list/<?php echo $row["id"]; ?>" class="btn btn-block btn-info btn-xs">Generate</a>
                            </td>
