...
<a href="<?php echo base_url() . $path_rel . '/' . $data['rel_version']; ?>" class="btn btn-default"><?php echo $this->lang->line('be_crud_cancel'); ?></a>
<a href="<?php echo base_url() . 'admin/cruds/campos_list/' . $data['id']; ?>" class="btn btn-info">Campos: <?php echo $data['campos']; ?></a>
