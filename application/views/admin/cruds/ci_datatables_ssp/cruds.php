...
?>
                        <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/ci_datatables_ssp/crud/<?php echo $row["id"]; ?>" class="btn btn-block btn-success btn-xs">CRUD</a>
                              <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/ci_datatables_ssp/generate_list/<?php echo $row["id"]; ?>" class="btn btn-block btn-info btn-xs">Generate</a>
                            </td>
