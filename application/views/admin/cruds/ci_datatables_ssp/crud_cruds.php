    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/ci_datatables_ssp/generate_cruds/<?php echo $id; ?>" class="btn btn-block btn-info btn-lg">Generate Codeigniter + Datatables.net + SSP</a>
