...
<a href="<?php echo base_url() . $path_rel; ?>/new/<?php echo $data['rel_tabla']; ?>" class="btn btn-default text-green" id="btnNew"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('be_crud_new'); ?></a>
