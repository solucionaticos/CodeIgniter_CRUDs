                ...
                <div class="col-sm-6 col-md-5">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" id="typeGeneration">
                      ...
                      <option value="2">CI Datatable + Modals</option>
                      <option value="3">CI Datatable + SSP</option>
                      <option value="6">CI Datatable + SSP 2.0</option>
                      <option value="4">Node.js APIs Adonis</option>
                      <option value="5">Node.js APIs Express</option>
                    </select>
