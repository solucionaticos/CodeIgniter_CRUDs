  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/apis_nodejs">APIs Node.js</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/apis_nodejs/generate/<?php echo $id; ?>" class="btn btn-block btn-info btn-lg">Generate APIs Node.js</a>
        </div>
      </div>
