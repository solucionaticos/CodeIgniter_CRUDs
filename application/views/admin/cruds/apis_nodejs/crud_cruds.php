  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/cruds/apis_nodejs/generate_cruds/<?php echo $id; ?>" class="btn btn-block btn-info btn-lg">Generate APIs Node.js</a>
        </div>
      </div>
