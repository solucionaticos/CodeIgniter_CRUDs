        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <div class="table-responsive">
                    ...
                    <table id="lista" class="display" cellspacing="0" width="100%"> -> SSP
                     -->
                    <table id="lista" class="table table-bordered table-striped" width="100%">
                        <thead>
                            <tr>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/database1/pais/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="abreviacion_i">Abreviacion:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="abreviacion_i" name="abreviacion">
                    	</div>
                    </div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open($this->config->item('adminPath') . '/database1/pais/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/database1/pais/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
