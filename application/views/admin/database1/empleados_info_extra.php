    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/database1/empleados_info_extra/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  
...
<?php } ?>
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="informacion_id_i">Informacion Id:</label>
                    	<div class="col-sm-10">
	                    	<input type="number" class="form-control" id="informacion_id_i" name="informacion_id">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="informacion_i">Informacion:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="informacion_i" name="informacion">
                    	</div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open($this->config->item('adminPath') . '/database1/empleados_info_extra/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
...
<?php } ?>
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="informacion_id_g">Informacion Id:</label>
                    	<div class="col-sm-10">
	                    	<input type="number" class="form-control" id="informacion_id_g" name="informacion_id">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="informacion_g">Informacion:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="informacion_g" name="informacion">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="active_g">Active:</label>
                    	<div class="col-sm-10">
	                    	<input type="number" class="form-control" id="active_g" name="active">
                    	</div>
                    </div>
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/database1/empleados_info_extra/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
