    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/database1/empresa/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  
                    ...
                    <div class="form-group">
                    	...
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="doc_identidad_i" name="doc_identidad">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="encargado_id_i">Encargado Id:</label>
                    	<div class="col-sm-10">
	                    	<select class="form-control" id="encargado_id_i" name="encargado_id" >
...
<?php foreach ($data["datos"]["tabla_pais"] as $registro) { ?>
	                    		<option value="<?=$registro['id']?>"><?=$registro['nombre']?></option>
<?php } ?>
	                    	</select>
                    	</div>
...
<?php foreach ($data["datos"]["tabla_estado"] as $registro) { ?>
	                    		<option value="<?=$registro['id']?>"><?=$registro['nombre']?></option>
<?php } ?>
	                    	</select>
                    	</div>
...
<?php foreach ($data["datos"]["tabla_ciudad"] as $registro) { ?>
	                    		<option value="<?=$registro['id']?>"><?=$registro['nombre']?></option>
<?php } ?>
	                    	</select>
                    	</div>
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open($this->config->item('adminPath') . '/database1/empresa/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
                    ...
                    <div class="form-group">
                    	...
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="doc_identidad_g" name="doc_identidad">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="encargado_id_g">Encargado Id:</label>
                    	<div class="col-sm-10">
	                    	<select class="form-control" id="encargado_id_g" name="encargado_id" >
<?php foreach ($data["datos"]["tabla_empleados"] as $registro) { ?>
	                    		<option value="<?=$registro['id']?>"><?=$registro['nombre']?></option>
<?php } ?>
	                    	</select>
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/database1/empresa/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
