    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/database1/empleados_documentos/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  
...
<?php } ?>
                    ...
                    <div class="form-group">
                    	...
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="descripcion_i" name="descripcion">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="ruta_archivo_i">Ruta Archivo:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="ruta_archivo_i" name="ruta_archivo">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="tipo_i">Tipo:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="tipo_i" name="tipo">
                    	</div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open($this->config->item('adminPath') . '/database1/empleados_documentos/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
...
<?php } ?>
                    ...
                    <div class="form-group">
                    	...
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="descripcion_g" name="descripcion">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="ruta_archivo_g">Ruta Archivo:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="ruta_archivo_g" name="ruta_archivo">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="tipo_g">Tipo:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="tipo_g" name="tipo">
                    	</div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open($this->config->item('adminPath') . '/database1/empleados_documentos/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
