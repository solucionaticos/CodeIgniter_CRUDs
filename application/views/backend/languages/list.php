        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                <div class="btn-groupx" style="margin-bottom: 10px;">
                    <a href="<?php echo base_url(); ?>backend/languages/new" class="btn btn-default text-green" id="btnNuevo"><span class="glyphicon glyphicon-plus"></span> Nuevo</a>
...
<?php echo form_open('backend/languages/delete', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
