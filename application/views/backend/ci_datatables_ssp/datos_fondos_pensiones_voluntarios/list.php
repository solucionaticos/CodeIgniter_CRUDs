...
<?php echo form_open($this->config->item('adminPath') . '/backend/ci_datatables_ssp/datos_fondos_pensiones_voluntarios/delete', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
