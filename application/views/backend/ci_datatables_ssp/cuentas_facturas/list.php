        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                <div class="btn-groupx" style="margin-bottom: 10px;">
                    ...
                    <a href="<?php echo base_url(); ?>backend/ci_datatables_ssp/cuentas_facturas/new" class="btn btn-default text-green" id="btnNuevo"><span class="glyphicon glyphicon-plus"></span> Nuevo</a>
...
<?php echo form_open('backend/ci_datatables_ssp/cuentas_facturas/delete', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
