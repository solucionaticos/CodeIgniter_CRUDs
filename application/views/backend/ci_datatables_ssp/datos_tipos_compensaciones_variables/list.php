...
<?php echo form_open($this->config->item('adminPath') . '/backend/ci_datatables_ssp/datos_tipos_compensaciones_variables/delete', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
