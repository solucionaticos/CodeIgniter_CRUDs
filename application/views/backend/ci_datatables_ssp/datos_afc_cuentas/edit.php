    ...
    <div class="col-xs-12">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <?php echo form_open('backend/ci_datatables_ssp/datos_afc_cuentas/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
...
<?php } ?>
				    ...
				    <div class="form-group"> 
				        <div class="col-sm-offset-2 col-sm-10">
				            ...
				            <a href="<?php echo base_url() . $this->config->item('adminPath'); ?>/backend/ci_datatables_ssp/datos_afc_cuentas" class="btn btn-default">Cancelar</a>
				        </div>
				    </div>
