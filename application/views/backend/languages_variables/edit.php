    ...
    <div class="col-xs-12">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <?php echo form_open('backend/languages_variables/update', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="environment_g">Environment:</label>
                    	<div class="col-sm-10">
	                    	<input type="number" class="form-control" id="environment_g" name="environment">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="records_g">Records:</label>
                    	<div class="col-sm-10">
	                    	<input type="number" class="form-control" id="records_g" name="records">
                    	</div>
                    </div>
                    <div class="form-group">
