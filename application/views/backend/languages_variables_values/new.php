    ...
    <div class="col-xs-12">
        <div class="box box-success box-solid">
            ...
            <div class="box-body">
                ...
                <?php echo form_open('backend/languages_variables_values/insert', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  

                    <input type='hidden' id='id_i' name='id' value='0'>
                    
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="variable_i">Variable:</label>
                    	<div class="col-sm-10">
	                    	<select class="form-control" id="variable_i" name="variable" >
...
<?php } ?>
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="language_i">Language:</label>
                    	<div class="col-sm-10">
	                    	<select class="form-control" id="language_i" name="language" >
