    ...
    <div class="col-xs-12">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <?php echo form_open('backend/datos/update', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="codigo_g">Codigo:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="codigo_g" name="codigo">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="numero_registros_g">Numero Registros:</label>
                    	<div class="col-sm-10">
	                    	<input type="number" class="form-control" id="numero_registros_g" name="numero_registros">
                    	</div>
                    </div>
                    <div class="form-group">
				    ...
				    <div class="form-group"> 
				        <div class="col-sm-offset-2 col-sm-10">
				            ...
				            <a href="<?php echo base_url(); ?>backend/datos" class="btn btn-default">Cancelar</a>
				        </div>
				    </div>
