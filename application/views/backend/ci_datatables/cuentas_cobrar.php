    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart('backend/ci_datatables/cuentas_cobrar/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open_multipart('backend/ci_datatables/cuentas_cobrar/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/cuentas_cobrar/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
