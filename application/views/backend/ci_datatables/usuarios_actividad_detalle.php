    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/usuarios_actividad_detalle/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open('backend/ci_datatables/usuarios_actividad_detalle/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
...
<?php } ?>
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="actividad_id_g">Actividad Id:</label>
                    	<div class="col-sm-10">
	                    	<select class="form-control" id="actividad_id_g" name="actividad_id" >
<?php foreach ($data["datos"]["tabla_usuarios_actividad"] as $registro) { ?>
	                    		<option value="<?=$registro['id']?>"><?=$registro['nombre']?></option>
<?php } ?>
	                    	</select>
                    ...
                    <div class="form-group">
                    	...
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="fecha_g" name="fecha">
                    	</div>
                    </div>
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="ruta_id_g">Ruta Id:</label>
                    	<div class="col-sm-10">
	                    	<select class="form-control" id="ruta_id_g" name="ruta_id" >
<?php foreach ($data["datos"]["tabla_datos_rutas"] as $registro) { ?>
	                    		<option value="<?=$registro['id']?>"><?=$registro['nombre']?></option>
<?php } ?>
	                    	</select>
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/usuarios_actividad_detalle/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
