    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/empleados_documentos/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  
...
<?php } ?>
                    ...
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="asunto_i">Asunto:</label>
                    	<div class="col-sm-10">
	                    	<input type="text" class="form-control" id="asunto_i" name="asunto">
                    	</div>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open('backend/ci_datatables/empleados_documentos/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/empleados_documentos/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
