    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/empresa_nomina_areas/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open('backend/ci_datatables/empresa_nomina_areas/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/empresa_nomina_areas/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
