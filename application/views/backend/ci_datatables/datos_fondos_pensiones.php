    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/datos_fondos_pensiones/ingresar', array('id' => 'forma_i', 'class' => 'form-horizontal')); ?>  

                    <input type='hidden' id='id_i' name='id' value='0'>
                    
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="pais_is_i">Pais Is:</label>
                    	<div class="col-sm-10">
	                    	<select class="form-control" id="pais_is_i" name="pais_is" >
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo form_open('backend/ci_datatables/datos_fondos_pensiones/guardar', array('id' => 'forma_g', 'class' => 'form-horizontal')); ?>              

                    <input type='hidden' id='id_g' name='id'>
                    
                    <div class="form-group">
                    	<label class="control-label col-sm-2" for="pais_is_g">Pais Is:</label>
                    	<div class="col-sm-10">
	                    	<select class="form-control" id="pais_is_g" name="pais_is" >
<?php foreach ($data["datos"]["tabla_datos_paises"] as $registro) { ?>
	                    		<option value="<?=$registro['id']?>"><?=$registro['nombre']?></option>
<?php } ?>
	                    	</select>
...
<div class="modal fade" id="modalEliminar" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('backend/ci_datatables/datos_fondos_pensiones/eliminar', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
