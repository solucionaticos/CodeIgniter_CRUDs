        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                <div class="btn-groupx" style="margin-bottom: 10px;">
                    <a href="<?php echo base_url(); ?>backend/cruds/new" class="btn btn-default text-green" id="btnNuevo"><span class="glyphicon glyphicon-plus"></span> Nuevo</a>
                    ...
                    <table id="lista" class="table table-bordered table-striped" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Carpeta 1</th>
                                <th>Carpeta 2</th>
                                <th>Lista Orden Campo</th>
                                <th>Lista Orden Direccion</th>
                                <th>Lista Condicion Campo</th>
                                <th>Lista Condicion Valor</th>
                                <th>Nuevo</th>
                                <th>Editar</th>
                                <th>Ver</th>
                                <th>Borrar</th>
...
<?php echo form_open('backend/cruds/delete', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
