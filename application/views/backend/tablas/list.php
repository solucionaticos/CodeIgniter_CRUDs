        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                <div class="btn-groupx" style="margin-bottom: 10px;">
                    <a href="<?php echo base_url(); ?>backend/tablas/new" class="btn btn-default text-green" id="btnNuevo"><span class="glyphicon glyphicon-plus"></span> Nuevo</a>
                    ...
                    <table id="lista" class="table table-bordered table-striped" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Etiqueta</th>
                                <th>Comentarios</th>
                                <th>Antes Insertar</th>
                                <th>Antes Actualizar</th>
                                <th>Antes Eliminar</th>
                                <th>Despues Insertar</th>
                                <th>Despues Actualizar</th>
                                <th>Despues Eliminar</th>
...
<?php echo form_open('backend/tablas/delete', array('id' => 'forma_e', 'class' => 'form-horizontal')); ?> 
