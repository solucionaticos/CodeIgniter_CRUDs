...
class Proyectos extends MY_Controller {
	...
	public function index() {
		...
		$this->parametros['vista'] = $this->config->item('adminPath') . base_url() . $this->config->item('adminPath') . '/tables/datatables/proyectos';
		$this->parametros['datos']['titulo'] = 'proyectos';
		$this->parametros['datos']['subtitulo'] = ''; 
		$tabla_proyectos = $this->Model->registros('proyectos', '', array() );
		$this->parametros['datos']['lista'] = $tabla_proyectos;
	...
	public function ingresar () {
		...
		redirect(base_url() . $this->config->item('adminPath') . '/tables/datatables/proyectos');
	}
