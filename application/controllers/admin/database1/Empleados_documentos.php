...
class Empleados_documentos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = $this->config->item('adminPath') . '/database1/empleados_documentos';
		$this->parameters['datos']['titulo'] = 'Empleados Documentos';
		...
		$this->admin_design->layout('database', $this->config->item('adminPath') . '/database1/empleados_documentos', $this->parameters, 'Empleados Documentos');
	}
	...
	public function ingresar () {
		...
		redirect(base_url() . $this->config->item('adminPath') . '/database1/empleados_documentos');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM empleados_documentos";
