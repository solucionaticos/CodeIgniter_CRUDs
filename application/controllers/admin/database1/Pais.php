...
/*
		...
		$this->parameters['vista'] = $this->config->item('adminPath') . '/database1/pais';
		$this->parameters['datos']['titulo'] = 'Pais';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', $this->config->item('adminPath') . '/database1/pais', $this->parameters, 'Pais');
*/

		$this->parameters['template'] = 'ssp';
		$this->parameters['type'] = 'list';
		$this->parameters['path'] = $this->config->item('adminPath') . '/database1/pais';
		$this->parameters['title'] = 'Pais';
	...
	public function ingresar () {
		...
		redirect(base_url() . $this->config->item('adminPath') . '/database1/pais');
	}
	...
	public function list_ssp () {
		...
		$columns = array(
			...
			array( 'db' => 'abreviacion', 'dt' => 4, 'field' => 'abreviacion' ),);
