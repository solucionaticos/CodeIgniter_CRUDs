...
class Empleados_contratos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = $this->config->item('adminPath') . '/database1/empleados_contratos';
		...
		$this->admin_design->layout('database', $this->config->item('adminPath') . '/database1/empleados_contratos', $this->parameters, 'Empleados Contratos');
	}
	...
	public function ingresar () {
		...
		redirect(base_url() . $this->config->item('adminPath') . '/database1/empleados_contratos');
	}
