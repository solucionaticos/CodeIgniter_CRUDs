...
class Empresa_nomina_areas extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/empresa_nomina_areas';
		$this->parameters['datos']['titulo'] = 'Empresa Nomina Areas';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/empresa_nomina_areas', $this->parameters, 'Empresa Nomina Areas');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/empresa_nomina_areas');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM empresa_nomina_areas";
