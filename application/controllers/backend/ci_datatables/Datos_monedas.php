...
class Datos_monedas extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_monedas';
		$this->parameters['datos']['titulo'] = 'Datos Monedas';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_monedas', $this->parameters, 'Datos Monedas');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_monedas');
	}
