...
class Datos_dispositivos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_dispositivos';
		$this->parameters['datos']['titulo'] = 'Datos Dispositivos';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_dispositivos', $this->parameters, 'Datos Dispositivos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_dispositivos');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_dispositivos";
