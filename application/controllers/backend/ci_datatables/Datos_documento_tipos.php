...
class Datos_documento_tipos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_documento_tipos';
		$this->parameters['datos']['titulo'] = 'Datos Documento Tipos';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_documento_tipos', $this->parameters, 'Datos Documento Tipos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_documento_tipos');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_documento_tipos";
