...
class Datos_banco_tipos_cuenta extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_banco_tipos_cuenta';
		$this->parameters['datos']['titulo'] = 'Datos Banco Tipos Cuenta';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_banco_tipos_cuenta', $this->parameters, 'Datos Banco Tipos Cuenta');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_banco_tipos_cuenta');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_banco_tipos_cuenta";
