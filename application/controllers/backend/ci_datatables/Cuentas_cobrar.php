...
class Cuentas_cobrar extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/cuentas_cobrar';
		$this->parameters['datos']['titulo'] = 'Cuentas Cobrar';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/cuentas_cobrar', $this->parameters, 'Cuentas Cobrar');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/cuentas_cobrar');
	}
