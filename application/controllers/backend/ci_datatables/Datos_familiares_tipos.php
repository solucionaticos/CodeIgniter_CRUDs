...
class Datos_familiares_tipos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_familiares_tipos';
		$this->parameters['datos']['titulo'] = 'Datos Familiares Tipos';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_familiares_tipos', $this->parameters, 'Datos Familiares Tipos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_familiares_tipos');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_familiares_tipos";
