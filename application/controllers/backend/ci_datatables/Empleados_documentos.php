...
class Empleados_documentos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/empleados_documentos';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/empleados_documentos', $this->parameters, 'Empleados Documentos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/empleados_documentos');
	}
