...
class Datos_paises extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_paises';
		$this->parameters['datos']['titulo'] = 'Datos Paises';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_paises', $this->parameters, 'Datos Paises');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_paises');
	}
