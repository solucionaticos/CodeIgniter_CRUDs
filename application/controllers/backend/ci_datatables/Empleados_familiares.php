...
class Empleados_familiares extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/empleados_familiares';
		$this->parameters['datos']['titulo'] = 'Empleados Familiares';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/empleados_familiares', $this->parameters, 'Empleados Familiares');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/empleados_familiares');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM empleados_familiares";
