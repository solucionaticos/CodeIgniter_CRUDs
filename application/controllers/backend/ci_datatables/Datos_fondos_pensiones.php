...
class Datos_fondos_pensiones extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_fondos_pensiones';
		$this->parameters['datos']['titulo'] = 'Datos Fondos Pensiones';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/datos_fondos_pensiones', $this->parameters, 'Datos Fondos Pensiones');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_fondos_pensiones');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_fondos_pensiones";
