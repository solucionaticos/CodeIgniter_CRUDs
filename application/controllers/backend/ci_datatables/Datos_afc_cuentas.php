...
class Datos_afc_cuentas extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_afc_cuentas';
		$this->parameters['datos']['titulo'] = 'Datos Afc Cuentas';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/datos_afc_cuentas', $this->parameters, 'Datos Afc Cuentas');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_afc_cuentas');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_afc_cuentas";
