...
class Datos_contratos_tipos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_contratos_tipos';
		$this->parameters['datos']['titulo'] = 'Datos Contratos Tipos';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_contratos_tipos', $this->parameters, 'Datos Contratos Tipos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_contratos_tipos');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_contratos_tipos";
