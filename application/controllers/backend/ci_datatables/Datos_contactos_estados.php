...
class Datos_contactos_estados extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_contactos_estados';
		$this->parameters['datos']['titulo'] = 'Datos Contactos Estados';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_contactos_estados', $this->parameters, 'Datos Contactos Estados');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_contactos_estados');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_contactos_estados";
