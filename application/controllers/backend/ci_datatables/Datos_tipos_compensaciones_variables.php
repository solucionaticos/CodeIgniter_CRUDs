...
class Datos_tipos_compensaciones_variables extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_tipos_compensaciones_variables';
		$this->parameters['datos']['titulo'] = 'Datos Tipos Compensaciones Variables';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_tipos_compensaciones_variables', $this->parameters, 'Datos Tipos Compensaciones Variables');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_tipos_compensaciones_variables');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_tipos_compensaciones_variables";
