...
class Datos_frecuencias_pagos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_frecuencias_pagos';
		$this->parameters['datos']['titulo'] = 'Datos Frecuencias Pagos';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_frecuencias_pagos', $this->parameters, 'Datos Frecuencias Pagos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_frecuencias_pagos');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_frecuencias_pagos";
