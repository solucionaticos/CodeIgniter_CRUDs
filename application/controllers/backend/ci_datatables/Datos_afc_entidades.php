...
class Datos_afc_entidades extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_afc_entidades';
		$this->parameters['datos']['titulo'] = 'Datos Afc Entidades';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/datos_afc_entidades', $this->parameters, 'Datos Afc Entidades');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_afc_entidades');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_afc_entidades";
