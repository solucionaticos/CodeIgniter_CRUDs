...
class Empleados extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/empleados';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/empleados', $this->parameters, 'Empleados');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/empleados');
	}
