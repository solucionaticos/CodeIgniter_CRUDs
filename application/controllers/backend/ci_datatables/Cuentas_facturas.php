...
class Cuentas_facturas extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/cuentas_facturas';
		$this->parameters['datos']['titulo'] = 'Cuentas Facturas';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/cuentas_facturas', $this->parameters, 'Cuentas Facturas');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/cuentas_facturas');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM cuentas_facturas";
