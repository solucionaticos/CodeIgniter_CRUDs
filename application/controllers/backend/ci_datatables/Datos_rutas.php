...
class Datos_rutas extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_rutas';
		$this->parameters['datos']['titulo'] = 'Datos Rutas';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_rutas', $this->parameters, 'Datos Rutas');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_rutas');
	}
