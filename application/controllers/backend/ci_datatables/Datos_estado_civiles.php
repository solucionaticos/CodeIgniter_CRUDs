...
class Datos_estado_civiles extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_estado_civiles';
		$this->parameters['datos']['titulo'] = 'Datos Estado Civiles';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_estado_civiles', $this->parameters, 'Datos Estado Civiles');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_estado_civiles');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_estado_civiles";
