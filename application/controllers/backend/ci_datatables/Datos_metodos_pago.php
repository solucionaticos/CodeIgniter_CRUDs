...
class Datos_metodos_pago extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_metodos_pago';
		$this->parameters['datos']['titulo'] = 'Datos Metodos Pago';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_metodos_pago', $this->parameters, 'Datos Metodos Pago');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_metodos_pago');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_metodos_pago";
