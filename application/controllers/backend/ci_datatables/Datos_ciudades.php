...
class Datos_ciudades extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_ciudades';
		$this->parameters['datos']['titulo'] = 'Datos Ciudades';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/datos_ciudades', $this->parameters, 'Datos Ciudades');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_ciudades');
	}
