...
class Empresa_sucursales extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/empresa_sucursales';
		$this->parameters['datos']['titulo'] = 'Empresa Sucursales';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/empresa_sucursales', $this->parameters, 'Empresa Sucursales');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/empresa_sucursales');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM empresa_sucursales";
