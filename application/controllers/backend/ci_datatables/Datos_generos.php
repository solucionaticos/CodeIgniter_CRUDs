...
class Datos_generos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_generos';
		$this->parameters['datos']['titulo'] = 'Datos Generos';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_generos', $this->parameters, 'Datos Generos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_generos');
	}
