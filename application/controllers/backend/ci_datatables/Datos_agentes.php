...
class Datos_agentes extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_agentes';
		$this->parameters['datos']['titulo'] = 'Datos Agentes';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_agentes', $this->parameters, 'Datos Agentes');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_agentes');
	}
