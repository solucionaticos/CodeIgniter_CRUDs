...
class Datos_usuarios_perfiles extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_usuarios_perfiles';
		$this->parameters['datos']['titulo'] = 'Datos Usuarios Perfiles';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_usuarios_perfiles', $this->parameters, 'Datos Usuarios Perfiles');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_usuarios_perfiles');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_usuarios_perfiles";
