...
class Empresa_centros_costo extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/empresa_centros_costo';
		$this->parameters['datos']['titulo'] = 'Empresa Centros Costo';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/empresa_centros_costo', $this->parameters, 'Empresa Centros Costo');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/empresa_centros_costo');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM empresa_centros_costo";
