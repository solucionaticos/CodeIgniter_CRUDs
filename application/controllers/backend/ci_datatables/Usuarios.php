...
class Usuarios extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/usuarios';
		$this->parameters['datos']['titulo'] = 'Usuarios';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/usuarios', $this->parameters, 'Usuarios');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/usuarios');
	}
