...
class Datos_bancos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_bancos';
		$this->parameters['datos']['titulo'] = 'Datos Bancos';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/datos_bancos', $this->parameters, 'Datos Bancos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_bancos');
	}
