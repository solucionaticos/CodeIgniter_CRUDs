...
class Datos_pqrs_tipos extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_pqrs_tipos';
		$this->parameters['datos']['titulo'] = 'Datos Pqrs Tipos';
		$this->parameters['datos']['subtitulo'] = ''; 

		$this->admin_design->layout('database', 'backend/ci_datatables/datos_pqrs_tipos', $this->parameters, 'Datos Pqrs Tipos');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_pqrs_tipos');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_pqrs_tipos";
