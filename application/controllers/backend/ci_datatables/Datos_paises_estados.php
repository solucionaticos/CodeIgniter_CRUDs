...
class Datos_paises_estados extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_paises_estados';
		$this->parameters['datos']['titulo'] = 'Datos Paises Estados';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/datos_paises_estados', $this->parameters, 'Datos Paises Estados');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_paises_estados');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_paises_estados";
