...
class Datos_fondos_cesantias extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['vista'] = 'backend/ci_datatables/datos_fondos_cesantias';
		$this->parameters['datos']['titulo'] = 'Datos Fondos Cesantias';
		...
		$this->admin_design->layout('database', 'backend/ci_datatables/datos_fondos_cesantias', $this->parameters, 'Datos Fondos Cesantias');
	}
	...
	public function ingresar () {
		...
		redirect('/backend/ci_datatables/datos_fondos_cesantias');
	}
	...
	public function lista_ssp () {
		...
		$joinQuery = "FROM datos_fondos_cesantias";
