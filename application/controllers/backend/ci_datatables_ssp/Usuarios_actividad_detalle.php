...
class Usuarios_actividad_detalle extends MY_Controller {
	...
	public function index() {
		...
		$this->parameters['path'] = $this->config->item('adminPath') . '/backend/ci_datatables_ssp/usuarios_actividad_detalle';
		$this->parameters['title'] = 'Usuarios Actividad Detalle';
		$this->parameters['subtitle'] = '';
		$this->parameters['head_title'] = $this->parameters['title'];
		$this->parameters['breadcrumb'] = '
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
			<li class="active">Usuarios Actividad Detalle</li>
		</ol>'; 
	...
	public function insert () {
		...
		if (!empty($post)) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($id > 0) {
					...
					redirect(base_url() . $this->config->item('adminPath') . '/backend/ci_datatables_ssp/usuarios_actividad_detalle');
				} else {
		...
		redirect(base_url() . $this->config->item('adminPath') . '/backend/ci_datatables_ssp/usuarios_actividad_detalle/new');
	}
	...
	public function update () {
		...
		redirect(base_url() . $this->config->item('adminPath') . '/backend/ci_datatables_ssp/usuarios_actividad_detalle/edit/'.$post['id']);   
	}
