...
class Empleados_contratos extends MY_Controller {
    ...
    public function index() {
        ...
        //-- Lista --------
        $crud->columns("empleado_id","fecha_inicio","fecha_fin","archivo");
        //-- Nuevo --------
        $crud->add_fields("empleado_id","fecha_inicio","fecha_fin","archivo");
        //-- Editar --------
        $crud->edit_fields("empleado_id","fecha_inicio","fecha_fin","archivo");
        //-- Etiquetas --------
