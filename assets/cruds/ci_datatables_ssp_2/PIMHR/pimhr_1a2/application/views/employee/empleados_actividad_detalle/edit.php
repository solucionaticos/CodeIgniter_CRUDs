	        ...
	        <div class="box box-primary box-solid">
	            ...
	            <div class="box-body">
	                ...
	                <?php echo form_open($path . '/update', array('id' => 'form_g', 'class' => 'form-horizontal')); ?>              
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="actividad_id_g">Actividad:</label>
	                    	<div class="col-sm-10">
	                    		<select class="form-control" id="actividad_id_g" name="actividad_id" >
<?php foreach ($data["table_empleados_actividad"] as $row) { ?>
...
<?php } ?>
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="ruta_id_g">Ruta:</label>
	                    	<div class="col-sm-10">
