	        ...
	        <div class="box box-success box-solid">
	            ...
	            <div class="box-body">
	                ...
	                <?php echo form_open($path . '/insert', array('id' => 'form_i', 'class' => 'form-horizontal')); ?>  
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="cliente_pre_orden_id_i">Cliente Pre Orden Id:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="cliente_pre_orden_id_i" name="cliente_pre_orden_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="metodo_pago_id_i">Metodo Pago Id:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="metodo_pago_id_i" name="metodo_pago_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="metodo_pago_i">Metodo Pago:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="metodo_pago_i" name="metodo_pago">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="transactionid_i">Transactionid:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="transactionid_i" name="transactionid">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="estado_orden_id_i">Estado Orden Id:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="estado_orden_id_i" name="estado_orden_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="fecha_estado_i">Fecha Estado:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="fecha_estado_i" name="fecha_estado">
	                    	</div>
	                    </div>
