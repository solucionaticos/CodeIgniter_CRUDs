...
<?php } ?>
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="tipo_id_g">Tipo:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="tipo_id_g" name="tipo_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="respuesta_g">Respuesta:</label>
	                    	<div class="col-sm-10">
	                    		<textarea class="form-control" rows="5" id="respuesta_g" name="respuesta"></textarea>
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="fecha_respuesta_g">Fecha Respuesta:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="fecha_respuesta_g" name="fecha_respuesta">
	                    	</div>
	                    </div>
