	        ...
	        <div class="box box-primary box-solid">
	            ...
	            <div class="box-body">
	                ...
	                <?php echo form_open($path . '/update', array('id' => 'form_g', 'class' => 'form-horizontal')); ?>              
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="cliente_pre_orden_id_g">Cliente Pre Orden Id:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="cliente_pre_orden_id_g" name="cliente_pre_orden_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="metodo_pago_id_g">Metodo Pago Id:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="metodo_pago_id_g" name="metodo_pago_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="metodo_pago_g">Metodo Pago:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="metodo_pago_g" name="metodo_pago">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="transactionid_g">Transactionid:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="transactionid_g" name="transactionid">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="estado_orden_id_g">Estado Orden Id:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="estado_orden_id_g" name="estado_orden_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="fecha_estado_g">Fecha Estado:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="fecha_estado_g" name="fecha_estado">
	                    	</div>
	                    </div>
