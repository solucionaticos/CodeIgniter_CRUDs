...
<?php } ?>
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="testimonio_i">Testimonio:</label>
	                    	<div class="col-sm-10">
	                    		<textarea class="form-control" rows="5" id="testimonio_i" name="testimonio"></textarea>
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="fecha_creacion_i">Fecha Creación:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control datepicker" id="fecha_creacion_i" name="fecha_creacion">
	                    	</div>
	                    </div>
	                    <div class="form-group">
