...
<?php } ?>
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="cliente_cuenta_id_i">Cuenta Id:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="cliente_cuenta_id_i" name="cliente_cuenta_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="motivo_i">Motivo:</label>
	                    	<div class="col-sm-10">
	                    		<textarea class="form-control" rows="5" id="motivo_i" name="motivo"></textarea>
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="fecha_cancelacion_i">Fecha Cancelacion:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="fecha_cancelacion_i" name="fecha_cancelacion">
	                    	</div>
	                    </div>
