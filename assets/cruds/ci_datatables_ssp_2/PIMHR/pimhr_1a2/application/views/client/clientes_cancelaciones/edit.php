...
<?php } ?>
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="cliente_cuenta_id_g">Cuenta Id:</label>
	                    	<div class="col-sm-10">
	                    		<input type="number" class="form-control" id="cliente_cuenta_id_g" name="cliente_cuenta_id">
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="motivo_g">Motivo:</label>
	                    	<div class="col-sm-10">
	                    		<textarea class="form-control" rows="5" id="motivo_g" name="motivo"></textarea>
	                    	</div>
	                    </div>
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="fecha_cancelacion_g">Fecha Cancelacion:</label>
	                    	<div class="col-sm-10">
	                    		<input type="text" class="form-control" id="fecha_cancelacion_g" name="fecha_cancelacion">
	                    	</div>
	                    </div>
