...
<?php } ?>
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="cliente_factura_id_g">Factura Id:</label>
	                    	<div class="col-sm-10">
	                    		<select class="form-control" id="cliente_factura_id_g" name="cliente_factura_id" >
...
<?php } ?>
	                    ...
	                    <div class="form-group">
	                    	<label class="control-label col-sm-2" for="metodo_pago_id_g">Método de Pago:</label>
	                    	<div class="col-sm-10">
	                    		<select class="form-control" id="metodo_pago_id_g" name="metodo_pago_id" >
