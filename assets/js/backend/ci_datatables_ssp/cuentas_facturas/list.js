$(function () {
	...
	$('#lista').DataTable( {
		"processing": true,
		"serverSide": true,
		"ajax": proyVar.base_url + "backend/ci_datatables_ssp/cuentas_facturas/list_ssp",
		'order': [[ 3, 'asc' ]],
	...
	$(document).on("click", ".btnEditar", function(){
		...
		location.href = proyVar.base_url + "backend/ci_datatables_ssp/cuentas_facturas/edit/" + id;
	});
