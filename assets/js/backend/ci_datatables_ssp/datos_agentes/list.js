$(function () {
	...
	$('#lista').DataTable( {
		"processing": true,
		"serverSide": true,
		"ajax": proyVar.base_url + proyVar.admin_path + "/backend/ci_datatables_ssp/datos_agentes/list_ssp",
		'order': [[ 3, 'asc' ]],
	...
	$(document).on("click", ".btnEditar", function(){
		...
		location.href = proyVar.base_url + proyVar.admin_path + "/backend/ci_datatables_ssp/datos_agentes/edit/" + id;
	});
