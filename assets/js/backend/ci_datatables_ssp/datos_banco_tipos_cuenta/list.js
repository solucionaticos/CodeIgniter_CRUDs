$(function () {
	...
	$('#lista').DataTable( {
		"processing": true,
		"serverSide": true,
		"ajax": proyVar.base_url + proyVar.admin_path + "/backend/ci_datatables_ssp/datos_banco_tipos_cuenta/list_ssp",
		'order': [[ 3, 'asc' ]],
	...
	$(document).on("click", ".btnEditar", function(){
		...
		location.href = proyVar.base_url + proyVar.admin_path + "/backend/ci_datatables_ssp/datos_banco_tipos_cuenta/edit/" + id;
	});
