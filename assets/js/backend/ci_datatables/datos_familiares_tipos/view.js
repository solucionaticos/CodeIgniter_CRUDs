...
$(function () {
	...
	$('#lista').DataTable({
		"ajax":proyVar.base_url + "backend/ci_datatables/datos_familiares_tipos/lista",
		'deferRender': true,
		'retrieve': true,
		'processing': true,   
		"language": {
	...
	function traerRegistro(id) {
		$.ajax({
			url: proyVar.base_url + "backend/ci_datatables/datos_familiares_tipos/traerRegistro",
			cache: false,
			dataType: "json",
			type: "post",
