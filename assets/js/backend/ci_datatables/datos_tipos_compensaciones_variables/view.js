...
$(function () {
	...
	$('#lista').DataTable({
		"ajax":proyVar.base_url + "backend/ci_datatables/datos_tipos_compensaciones_variables/lista",
		'deferRender': true,
		'retrieve': true,
		'processing': true,   
		"language": {
	...
	function traerRegistro(id) {
		$.ajax({
			url: proyVar.base_url + "backend/ci_datatables/datos_tipos_compensaciones_variables/traerRegistro",
			cache: false,
			dataType: "json",
			type: "post",
