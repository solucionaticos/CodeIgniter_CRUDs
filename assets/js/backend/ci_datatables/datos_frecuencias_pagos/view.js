...
$(function () {
	...
	$('#lista').DataTable({
		"ajax":proyVar.base_url + "backend/ci_datatables/datos_frecuencias_pagos/lista",
		'deferRender': true,
		'retrieve': true,
		'processing': true,   
		"language": {
	...
	function traerRegistro(id) {
		$.ajax({
			url: proyVar.base_url + "backend/ci_datatables/datos_frecuencias_pagos/traerRegistro",
			cache: false,
			dataType: "json",
			type: "post",
