...
$(function () {
	...
	$('#lista').DataTable({
		"ajax":proyVar.base_url + "backend/ci_datatables/datos_fondos_pensiones_voluntarios/lista",
		'deferRender': true,
		'retrieve': true,
		'processing': true,   
		"language": {
	...
	function traerRegistro(id) {
		$.ajax({
			url: proyVar.base_url + "backend/ci_datatables/datos_fondos_pensiones_voluntarios/traerRegistro",
			cache: false,
			dataType: "json",
			type: "post",
