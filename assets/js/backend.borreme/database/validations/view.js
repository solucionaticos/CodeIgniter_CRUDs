$(function () {
	...
	$("#tabla").change(function () {
		...
		if (tabla > 0) {
			...
			if (tabla > 0) {
				$.ajax({
					url: proyVar.base_url + proyVar.admin_path + "/database/validations/campos",
					cache: false,
					dataType: "json",
					type: "post",
					data: {"tabla":tabla, "project":project, "version":version, slcnts:tksec},
...
//	$(".validacion_eliminar").click(function () {
	...
	function actDato(id, valor, campo) {
		$.ajax({
			url: proyVar.base_url + proyVar.admin_path + "/database/validations/actdato",
			cache: false,
			dataType: "json",
			type: "post",
...
//				tksec = datos.tksec;
	...
	function mostrarCampo(id) {
		...
		$.ajax({
			url: proyVar.base_url + proyVar.admin_path + "/database/validations/campo",
			cache: false,
			dataType: "json",
			type: "post",
	...
	$("#validacion_nuevo").click(function () {
		...
		$.ajax({
			url: proyVar.base_url + proyVar.admin_path + "/database/validations/insvalidacion",
			cache: false,
			dataType: "json",
			type: "post",
	...
	function actValidacion(id, valor, campo) {
		$.ajax({
			url: proyVar.base_url + proyVar.admin_path + "/database/validations/actvalidacion",
			cache: false,
			dataType: "json",
			type: "post",
			data: {"id":id, "campo":campo, "valor":valor, slcnts:tksec},
...
/*
	$(document).on("click", ".validacion_eliminar", function () {
		var id = $(this).attr("campos_val_id");
		$.ajax({
			url: proyVar.base_url + proyVar.admin_path + "/database/validations/delvalidacion",
			cache: false,
			dataType: "json",
			type: "post",
...
// al cargar el campo tambien debe cargar las validaciones
	...
	$("#campo_relacion_tabla").change(function () {
		...
		//if (campo_relacion_campo == '' || campo_relacion_campo == null) {
			$.ajax({
				url: proyVar.base_url + proyVar.admin_path + "/database/validations/relacion_campo",
				cache: false,
				dataType: "json",
				type: "post",
