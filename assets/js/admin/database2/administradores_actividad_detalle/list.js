$(function() {
  ...
  var tksec = proyVarS.sgch; 
	...
	$('#lista').DataTable( {
		"processing": true,
		"serverSide": true,
		"ajax": proyVar.base_url + proyVar.admin_path + "/database2/administradores_actividad_detalle/list_ssp",
		'order': [[ 3, 'asc' ]],
	...
	$(document).on("click", ".btnEditar", function(){
		...
		location.href = proyVar.base_url + proyVar.admin_path + "/database2/administradores_actividad_detalle/edit/" + id;
	});
