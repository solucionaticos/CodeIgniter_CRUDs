...
$(function () {
	...
	$('#lista').DataTable({
		"ajax":proyVar.base_url + proyVar.admin_path + "/database1/empleados_info_extra/lista",
		'deferRender': true,
		'retrieve': true,
		'processing': true,   
		"language": {
	...
	function traerRegistro(id) {
		$.ajax({
			url: proyVar.base_url + proyVar.admin_path + "/database1/empleados_info_extra/traerRegistro",
			cache: false,
			dataType: "json",
			type: "post",
